                ...
                <Col md={7} className="d-flex align-items-center justify-content-center flex-direction-column">
                    <Form style={{ width: "80%", maxWidth: 500 }} onSubmit={handleSignup}>
                        ...
                        <div className="signup-profile-pic__container">
                            <img src={imagePreview || avatar1} className="signup-profile-pic" />
                        ...
                        <Form.Group className="mb-3" controlId="formBasicName">
                            ...
                            <Form.Control type="text" placeholder="Inserisci nome" onChange={(e) => setName(e.target.value)} value={name} />
                        </Form.Group>
                        <Form.Group className="mb-3" controlId="formBasicEmail">
                            <Form.Label>Email </Form.Label>
                            <Form.Control type="email" placeholder="Inserisci email" onChange={(e) => setEmail(e.target.value)} value={email} />
